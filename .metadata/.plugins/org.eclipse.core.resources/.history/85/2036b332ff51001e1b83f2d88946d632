...
#define SPI1_CLOCK_POLARITY                  SPI_IDLE_HIGH            // Clock polarity (default is idle low)
#define SPI1_CLOCK_PHASE                     SPI_FAILING_EDGE         // Clock phase (default is rising edge)
